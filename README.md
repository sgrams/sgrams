...
I'm a Senior Firmware Development Engineer at Intel Corporation, focused primarily on TDX Virtual Firmware and BIOS work.
...
`Rust` `UEFI` `BIOS` `TDX` `virtualization` `low-level debugging` `Linux` `C` `Python`
